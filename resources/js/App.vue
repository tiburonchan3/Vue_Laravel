        ...
        <nav class="navbar-dark container mt-4">
            <div class="navbar-content">
                ...
                <div v-if="isAdmin && isAutenticated" class="verify">
                    ...
                    <router-link to="/tipos" class="nav-child"><span @click="Show()">Tipos de comida</span></router-link>
                    <router-link to="/users" class="nav-child"><span @click="Show()">Usuarios</span></router-link>
                    <router-link to="/orders" class="nav-child"><span @click="Show()">Ordenes</span></router-link>
                    <router-link to="/cuenta" class="nav-child"><span @click="Show()">Mi cuenta</span></router-link>
                </div>
            </div>
        </nav>
