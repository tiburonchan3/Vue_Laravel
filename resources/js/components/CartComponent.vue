            ...
            <table class="table table-striped text-left">
              <tbody>
                <tr v-for="cart in carts" :key="cart.id">
                  <td>
                    <img
                      :src="'/images/productos/' + cart.image"
                      alt=""
                      width="50"
                      height="50"
                    />
...
<script>
import { AddCartEvent } from "../components/ProductItemComponent";
import { AddOnDetail } from "../pages/Detail";
export default {
  data() {
    return {
      resultado: 0,
