                ...
                <table class="table text-white">
                    ...
                    <tbody>
                        <tr v-for="(producto,index) in productos" :key="index">
                            ...
                            <td><img :src="'/images/productos/'+producto.image" width="80" height="80"></td>
                            ...
                            <div class="col-8" v-if="productoEdit">
                                <form @submit.prevent="UpdateProduct(productoEdit.id)">
                                    <div class="form-group row">
                                        ...
                                        <input id="nombre_producto" :value="productoEdit.nombre" class="form-control col-9" type="text" name="">
                                    </div>
                                    <div class="form-group row">
