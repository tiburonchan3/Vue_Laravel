            ...
            <tr>
              ...
              <td>
                <button
                  ...
                  data-target="#my-modal-edit"
                  data-toggle="modal"
                >
                  Editar
                </button>
                <button @click="Delete(tipo.id)" class="btn btn-sm btn-danger">
                  Eliminar
                </button>
              </td>
            </tr>
          ...
          <div class="modal-body">
            ...
            <form @submit.prevent="Update(tipo.id)">
              <div class="form-group row">
                <label class="col-form-label col-4" for="my-input"
                  >Nombre</label
                >
                <div class="col-8">
                  <input
                    v-bind:value="tipo.name"
                    id="name"
                    readonly
                    class="form-control"
                    type="text"
              ...
              <div class="row">
                ...
                <button class="btn btn-danger col-3 ml-1" data-dismiss="modal">
                  cancelar
                </button>
              </div>
            </form>
...
export default {
  ...
  methods: {
    ...
    Delete(id) {
      axios.delete("/tipo/destroy/" + id, { id: id }).then((resp) => {
        toast.fire({
          icon: "success",
